  ...
  <?php
    ...
    foreach ( $posts as $post ) : setup_postdata( $post ); $i++;
      ...
      <div class="fb-locations--location">
        <?php if ( !$instance['show_image'] && $instance['show_map'] ) : ?>
        ...
        <?php elseif ( $instance['show_image'] && has_post_thumbnail() ) : ?>
        ...
        <div class="fb-locations--location-meta">
          ...
          <a href="mailto:<?php echo $ctc_location_times; ?>" class="fb-locations--location-times">
